...
pub struct RegisterBlock {
    ...
    pub RDROR: crate::RORegister<u32>,
    _reserved5: [u8; 0x0380],
    #[doc = "Transmit Command Burst"]
    pub TCBR: crate::WORegister<u32>,
    #[doc = "Transmit Data Burst"]
    pub TDBR: [crate::WORegister<u32>; 128usize],
    #[doc = "Receive Data Burst"]
    pub RDBR: [crate::RORegister<u32>; 128usize],
}
#[doc = "Version ID"]
pub mod VERID {
