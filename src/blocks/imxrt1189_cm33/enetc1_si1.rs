...
pub struct RegisterBlock {
    ...
    pub SIBLPR: [crate::RORegister<u32>; 2usize],
    ...
    pub VSIIER: crate::RWRegister<u32>,
    _reserved17: [u8; 0x04],
    #[doc = "Virtual station interface interrupt detect register"]
    pub VSIIDR: crate::RWRegister<u32>,
    _reserved18: [u8; 0x0c],
    ...
    pub SIMSIVR: crate::RWRegister<u32>,
    ...
    pub SIMSITRVR: [crate::RWRegister<u32>; 10usize],
    _reserved24: [u8; 0x58],
    #[doc = "Station interface MSI-X receive ring a vector register"]
    pub SIMSIRRVR: [crate::RWRegister<u32>; 10usize],
