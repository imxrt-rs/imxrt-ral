//! Register access layer for imxrt1061
...
pub struct Peripherals {
    ...
    pub USBPHY1: usbphy::Instance<U1>,
    pub USBPHY2: usbphy::Instance<U2>,
    ...
    pub FLEXIO1: flexio::Instance<U1>,
    pub FLEXIO2: flexio::Instance<U2>,
    pub FLEXIO3: flexio::Instance<U3>,
    pub GPIO1: gpio::Instance<U1>,
    pub GPIO5: gpio::Instance<U5>,
    pub GPIO2: gpio::Instance<U2>,
    pub GPIO3: gpio::Instance<U3>,
    pub GPIO4: gpio::Instance<U4>,
    pub GPIO6: gpio::Instance<U6>,
    pub GPIO7: gpio::Instance<U7>,
    pub GPIO8: gpio::Instance<U8>,
    pub GPIO9: gpio::Instance<U9>,
    pub CAN1: can::Instance<U1>,
    pub CAN2: can::Instance<U2>,
    pub CAN3: can3::Instance,
    pub TMR1: tmr::Instance<U1>,
    pub TMR2: tmr::Instance<U2>,
    pub TMR3: tmr::Instance<U3>,
    pub TMR4: tmr::Instance<U4>,
    pub GPT1: gpt::Instance<U1>,
    pub GPT2: gpt::Instance<U2>,
    pub OCOTP: ocotp::Instance,
    pub IOMUXC: iomuxc::Instance,
    pub KPP: kpp::Instance,
    pub FLEXSPI1: flexspi::Instance<U1>,
    pub FLEXSPI2: flexspi::Instance<U2>,
    pub USDHC1: usdhc::Instance<U1>,
    pub USDHC2: usdhc::Instance<U2>,
    pub ENET1: enet::Instance<U1>,
    pub ENET2: enet::Instance<U2>,
    pub USB1: usb::Instance<U1>,
    pub USB2: usb::Instance<U2>,
    pub USBNC1: usbnc::Instance<U1>,
    pub USBNC2: usbnc::Instance<U2>,
    ...
    pub AOI1: aoi::Instance<U1>,
    pub AOI2: aoi::Instance<U2>,
    pub XBARA1: xbara1::Instance,
    pub XBARB2: xbarb::Instance<U2>,
    pub XBARB3: xbarb::Instance<U3>,
    pub ENC1: enc::Instance<U1>,
    pub ENC2: enc::Instance<U2>,
    pub ENC3: enc::Instance<U3>,
    pub ENC4: enc::Instance<U4>,
    pub PWM1: pwm::Instance<U1>,
    pub PWM2: pwm::Instance<U2>,
    pub PWM3: pwm::Instance<U3>,
    pub PWM4: pwm::Instance<U4>,
